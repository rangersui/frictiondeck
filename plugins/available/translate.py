...
SKILL = """\
# Translate — Bidirectional Format Conversion
...
## Typical workflow
Browser extension captures HTML → translate to markdown → store in world.
External data → translate → clean format → store.
This is the inbound half. dom_patch is the outbound half.
"""
ROUTES = {}
