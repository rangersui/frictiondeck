...
| `dav.py` | `/dav/*` | WebDAV view over the FHS tree; reads are public like core reads, writes require auth, system-prefix writes require approve; auto-registered at boot so the implementation stays out of `server.py` |
